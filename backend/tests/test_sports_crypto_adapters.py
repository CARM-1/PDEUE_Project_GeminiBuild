...
def test_cross_category_screener_four_domains():
    ...
    board = [
        ...
        {'contract_id': 'CRYPTO-01', 'category': 'CRYPTO', 'venue': 'POLYMARKET', 'yes_bid': 0.28, 'yes_ask': 0.32, 'underwriting_spec': {'spot_price': 115000.0, 'strike_price': 120000.0, 'annualized_vol': 0.55, 'days_to_expiry': 14.0}}
    ]
