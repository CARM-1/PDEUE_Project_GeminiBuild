...
def test_screen_strike_ladder_ranks_maximum_mispricing():
    ...
    ladder = [
        {'contract_id': 'KX-ORD-20', 'strike_temp_c': 20.0, 'yes_bid': 0.90, 'yes_ask': 0.94},
        {'contract_id': 'KX-ORD-24', 'strike_temp_c': 24.0, 'yes_bid': 0.80, 'yes_ask': 0.84},
        {'contract_id': 'KX-ORD-26', 'strike_temp_c': 26.0, 'yes_bid': 0.25, 'yes_ask': 0.30},
        {'contract_id': 'KX-ORD-28', 'strike_temp_c': 28.0, 'yes_bid': 0.05, 'yes_ask': 0.08},
        {'contract_id': 'KX-ORD-30', 'strike_temp_c': 30.0, 'yes_bid': 0.01, 'yes_ask': 0.03}
    ]
...
def test_screen_strike_ladder_filters_negative_edge():
    ...
    ladder = [
        {'contract_id': 'KX-EFFICIENT-20', 'strike_temp_c': 20.0, 'yes_bid': 0.60, 'yes_ask': 0.70}
    ]
