...
class OperatorWorkspaceService:
    ...
    def get_workspace_state(self, db_session = None) -> Dict[str, Any]:
        board_sample = [
            ...
            {'contract_id': 'POLY-BTC-120K', 'category': 'CRYPTO', 'venue': 'POLYMARKET', 'yes_bid': 0.20, 'yes_ask': 0.24, 'underwriting_spec': {'spot_price': 115000.0, 'strike_price': 120000.0, 'annualized_vol': 0.55, 'days_to_expiry': 14.0}}
        ]
